...
public class App {
    ...
    */
    ...
    public static Vuelo obtenerVueloMaxPasajeros1(List<Vuelo> vuelos) {
        return vuelos.stream()
                .max(Comparator.comparing(Vuelo::getNumeroPasajeros))
                .orElse(null);
    }
    //4.
    public static List<Vuelo> obtenerVuelosOrderDescByNumPasajeros(List<Vuelo> vuelos) {
        return vuelos.stream()
                .sorted(Comparator.reverseOrder()).toList();
    }
    //5.
    public static int obtenerTotalPasajeros(List<Vuelo> vuelos) {
        return vuelos.stream()
                .mapToInt(Vuelo::getNumeroPasajeros)
                .sum();
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(obtenerVueloMaxPasajeros1(vuelos));
        ...
        List<Vuelo> vuelosOrdenadosByNumPasajeros = obtenerVuelosOrderDescByNumPasajeros(vuelos);
